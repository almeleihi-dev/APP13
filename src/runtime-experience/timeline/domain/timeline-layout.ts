...
export interface TimelineLayoutBinding {
  layoutId: string;
  mode: "need" | "shared";
...
export function resolveTimelineLayoutBinding(_screenId: TimelineScreenId): TimelineLayoutBinding {
  return {
...
export function buildTimelineScreenContext(input?: {
...
export function resolveTimelineThemeColors() {
