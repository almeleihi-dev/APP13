...
if [[ -n "$DOCKER" ]]; then
  echo "==> Starting PostgreSQL (Docker) for S3/S4/S5/S6 regression suite"
...
echo "==> S6 provider public profile tests"
...
echo "S6 provider public profile verification complete"
