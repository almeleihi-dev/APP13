...
if [[ -n "$DOCKER" ]]; then
  echo "==> Starting PostgreSQL (Docker) for X30 regression suite"
...
echo "==> X29 post-launch monitoring center regression"
npm run verify:x29

echo "==> X30 business intelligence center experience tests"
...
echo "X30 business intelligence center experience verification complete"
