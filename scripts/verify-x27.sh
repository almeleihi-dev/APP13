...
if [[ -n "$DOCKER" ]]; then
  echo "==> Starting PostgreSQL (Docker) for X27 regression suite"
...
echo "==> X26 security and compliance readiness regression"
npm run verify:x26

echo "==> X27 platform operations center experience tests"
...
echo "X27 platform operations center experience verification complete"
