...
if [[ -n "$DOCKER" ]]; then
  echo "==> Starting PostgreSQL (Docker) for X26 regression suite"
...
echo "==> X25 production readiness center regression"
npm run verify:x25

echo "==> X26 security and compliance readiness center experience tests"
...
echo "X26 security and compliance readiness center experience verification complete"
