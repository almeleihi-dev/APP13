...
if [[ -n "$DOCKER" ]]; then
  echo "==> Starting PostgreSQL (Docker) for S3–S9 regression suite"
...
echo "==> S9 customer order dashboard tests"
...
echo "S9 customer order dashboard verification complete"
