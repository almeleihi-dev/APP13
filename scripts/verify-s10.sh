...
if [[ -n "$DOCKER" ]]; then
  echo "==> Starting PostgreSQL (Docker) for S3–S10 regression suite"
...
echo "==> S10 provider work dashboard tests"
...
echo "S10 provider work dashboard verification complete"
