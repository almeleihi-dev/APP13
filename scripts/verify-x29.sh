...
if [[ -n "$DOCKER" ]]; then
  echo "==> Starting PostgreSQL (Docker) for X29 regression suite"
...
echo "==> X28 launch control center regression"
npm run verify:x28

echo "==> X29 post-launch monitoring center experience tests"
...
echo "X29 post-launch monitoring center experience verification complete"
